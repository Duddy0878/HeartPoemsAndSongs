...
import { customerCart, saveToCustomerCartStorage} from "../acount.js"
...
orders.forEach((order) => {
  if(order.status === 'none' || order.status === 'shiping'){
...
document.querySelector('.js-data-total')
  .innerHTML = `<div class="more-text2">New</div>${totalOrders}<div class="more-text2">Orders</div>`
} 
function orderList (){
  displayOrders();
  ...
  function displayOrders () {
    ...
    orders.forEach((order) => {
      ...
      if(order.status ===  'shiping' || order.status ===  'none'){
      ...
      let shipingHTML = `<svg class="removeAdd2" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#8B1A10"><path d="M280-160q-50 0-85-35t-35-85H60l18-80h113q17-19 40-29.5t49-10.5q26 0 49 10.5t40 29.5h167l84-360H182l4-17q6-28 27.5-45.5T264-800h456l-37 160h117l120 160-40 200h-80q0 50-35 85t-85 35q-50 0-85-35t-35-85H400q0 50-35 85t-85 35Zm357-280h193l4-21-74-99h-95l-28 120Zm-19-273 2-7-84 360 2-7 34-146 46-200ZM20-427l20-80h220l-20 80H20Zm80-146 20-80h260l-20 80H100Zm180 333q17 0 28.5-11.5T320-280q0-17-11.5-28.5T280-320q-17 0-28.5 11.5T240-280q0 17 11.5 28.5T280-240Zm400 0q17 0 28.5-11.5T720-280q0-17-11.5-28.5T680-320q-17 0-28.5 11.5T640-280q0 17 11.5 28.5T680-240Z"/></svg>`
  ...
  ordersHtml += `
        ...
        <div class="data-each-row">
           ...
           <div class="data-each-row js-product-info-">
               ${productInfoHtml} <br> <div class="moreBtn">More</div>
           </div>
            <div class="data-each-row">
              ${order.deliverAt}
           </div>
          ...
          // }
            ...
            function checksts () {
             if(matchStat.status === 'none'){
                Swal.fire({
                  title: "This Actoin Will Change Status of Item To Shiping",
                  text: "This Will Affect sensitive Info!",
                  icon: "warning",
              ...
              Swal.fire({
                title: "This Actoin Will Change Status of Item To Complete",
                text: "This Will Affect sensitive Info!",
                icon: "warning",
                showCancelButton: true,
                confirmButtonText: "Yes, Change Status",
    ...
    document.querySelectorAll('.removeAdd')
     .forEach((remove) => {
      remove.addEventListener('click', () => {
        ...
        const oldId = remove.dataset.removeId
        let statCancel
        function cancelOrder () {
          ...
          Swal.fire({
            title: "This Actoin Will Cancel This Order ",
            text: "This Will Affect sensitive Info!",
            icon: "warning",
            showCancelButton: true,
            ...
            if(result.isConfirmed){
              statCancel.status = 'cancel'
              saveToOrdersStorage(orders);
              orderList();
              Swal.fire({
                title: "Successfuly Canceled",
                icon: "success",
                showConfirmButton: false,
                timer: 1500,
                color: "#c2a579",
